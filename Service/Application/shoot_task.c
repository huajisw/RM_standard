...
//15m/s横线
		Judge_Graphic_Line_Create(960-25,540-80,960+15,540-80,2,COLOR_ORANGE); //1M左右
		Judge_Graphic_Line_Create(960-35,540-90,960+25,540-90,2,COLOR_ORANGE); //2M左右
		Judge_Graphic_Line_Create(960-35,540-105,960+25,540-105,2,COLOR_WHITE); //Pitch最大时前哨站

//竖线
		Judge_Graphic_Line_Create(960-5,540-120,960-5,540-30,2,COLOR_YELLOW);  //激光竖线
		
//30m/s横线
		Judge_Graphic_Line_Create(960-25,540-40,960+15,540-40,2,COLOR_GREEN); //3M左右
		Judge_Graphic_Line_Create(960-35,540-50,960+25,540-50,2,COLOR_GREEN); //5M左右
		Judge_Graphic_Line_Create(960-30,540-55,960+20,540-55,2,COLOR_WHITE); //5M左右前哨站
